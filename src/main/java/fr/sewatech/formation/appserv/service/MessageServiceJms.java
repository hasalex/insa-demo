...
public final class MessageServiceJms {
    private static final Logger logger = Logger.getLogger(MessageServiceJms.class);
    ...
    public fr.sewatech.formation.appserv.service.Message getMessage() {
        try {
            ...
            return (message == null ? new fr.sewatech.formation.appserv.service.Message("Aucun message", null) : (fr.sewatech.formation.appserv.service.Message) message.getObject());
        } catch (Exception e) {
    ...
    private Session initialize() throws Exception {
        ...
        try {
            ...
            if (connectionFactory == null) {
                ...
                queue = (Queue) jndiContext.lookup("java:comp/env/jms/SWq");
            }
