<%@ page import="fr.sewatech.formation.appserv.service.SewaException" %>
...
<table style='border: 1px solid rgb(204, 204, 204);' align='center' cellpadding='0' cellspacing='0' width='1000'>
    ...
    <tr>
        <td colspan="2">
            <div id="head">
                <h1>Formation Serveurs d'Applications</h1>
            </div>
        </td>
    </tr>
    ...
    <tr height='20'>
        <td valign='top' colspan="2">
            <div id='foot' align='center'>
                &copy; <a href='http://www.sewatech.fr'>sewatech</a>
            </div>
        </td>
    </tr>
    </tbody>
...
<%! String getMessage(Throwable e) {
    if ((e instanceof ServletException) && (e.getCause() != null))
        e = e.getCause();
    if ((e instanceof SewaException) && (e.getCause() != null))
        e = e.getCause();

    String message = (e == null ? "mais je ne sais pas lequel" : (e.getMessage() == null ? e.getClass().getName() : e.toString()));
